...
Public Class Form1
    ...
    End Sub
    Private Sub lblExt_Click(sender As Object, e As EventArgs) Handles lblExt.Click

    End Sub

    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles lblPreview.Click

    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnRename.Click
    ...
    Private Sub RadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles rbReplaceWithF.CheckedChanged, rbReplaceWithF.Click
    ...
    Private Sub RadioButton3_CheckedChanged(sender As Object, e As EventArgs) Handles rbInsertBeforeF.CheckedChanged, rbInsertBeforeF.Click
    ...
    Private Sub Label1_Click_1(sender As Object, e As EventArgs) Handles lblWithThisF.Click

    End Sub

    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles txtWithThisF.TextChanged

    End Sub

    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txtReplaceWithF.TextChanged
    ...
    Private Sub rbReplaceThisF_CheckedChanged(sender As Object, e As EventArgs) Handles rbReplaceThisF.CheckedChanged, rbReplaceThisF.Click
    ...
    Private Sub lvOri_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvOri.SelectedIndexChanged
